...
const AdminLessonCard = ({
  ...
  return (
    <div className="max-w-96 min-w-78 h-48 border border-primary  text-white font-bold rounded-4xl px-5 py-3 flex flex-col justify-between cursor-pointer hover:-translate-y-1 hover:shadow-effective transition-all duration-300 group relative">
      {loading && (
        <div className="rounded-4xl top-0 left-0 z-50 backdrop-blur-lg bg-black/30 h-full w-full flex items-center justify-center absolute">
