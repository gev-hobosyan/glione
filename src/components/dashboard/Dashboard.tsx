...
const Dashboard = () => {
	return (
		<div className="w-full min-h-screen p-3 bg-black/40 rounded-3xl border border-primary/40 grid grid-cols-4 grid-rows-5 gap-4 ">
				...
				<SimpleDashboard className=""
					number="9"
					text={t("Streak")}
					icon={<Flame className="stroke-primary mt-1 ml-1" />}
				/>

				<SimpleDashboard className="col-start-1 row-start-2"
					number="5"
					text={t("Finished")}
					icon={<ClipboardCheck className="stroke-primary mt-1 ml-1" />}
				/>

				<SimpleDashboard className="col-start-1 row-start-3"
					number="32"
					text={t("HoursLearned")}
					icon={<Clock10 className="stroke-primary mt-1 ml-1 w-5" />}
				/>

				<SimpleDashboard className="col-start-1 row-start-4"
					number="85"
					text={t("AvgScore")}
