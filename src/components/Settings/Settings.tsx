...
const Settings = () => {
  ...
  const name = session?session["user"]["user_metadata"]["full_name"].split(" "):["Name","Surname"];
  ...
  return (
    <div className="w-screen h-screen backdrop-blur-2xl z-10 absolute flex items-center justify-center">
      <div className="w-9/10 h-9/10 bg-black/70 rounded-4xl border border-primary shadow-effective flex items-center">
        ...
        <div className="w-[80%] h-full flex flex-col items-start justify-between  px-6 py-13">
          ...
          <div className="border border-primary px-6 rounded-xl flex items-center w-full h-[20%]">
            ...
            />
            <div>
              <p className="text-white font-bold px-4 mt-1">{session?session["user"]["user_metadata"]["name"]:"Name"}</p>
              <p className="text-gray-400 px-4 mt-1">{session?session["user"]["email"]:"Email"}</p>
            </div>
          </div>
          ...
          <div className="border border-primary px-4 rounded-xl w-full h-[35%] pt-2 pb-5">
            ...
            <div className="grid grid-cols-2 grid-rows-3 gap-4 text-white h-full w-[60%] pb-5">
              ...
              <p className="text-white">{session?session["user"]["email"]:"No email"}</p>
              </div>
              <div>
              <p className="text-gray-400">Phone number</p>
              <p className="text-white">{phone || "No Phone number"}</p>
              </div>
              <div>
          ...
          <div className="border border-primary px-4 rounded-xl w-full h-[25%]">
